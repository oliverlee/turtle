...
constexpr auto make_arraylike_impl(Iter first, std::index_sequence<Is...>)
    -> ArrayLike
{
...
constexpr auto make_arraylike_impl(R range, std::index_sequence<Is...>)
    -> ArrayLike
{
...
{
    return detail::make_arraylike_impl<ArrayLike>(
        first, std::make_index_sequence<N>{});
}
